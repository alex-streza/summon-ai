...
const BuyMeACoffeeWidget = () => {
	return (
		<a
			className="px-4 py-3 flex items-center gap-2 bg-green-400 text-xs rounded-lg no-underline text-white font-semibold"
...
export const AboutTab = () => {
	return (
		<Fragment>
			...
			<h1 className="text-[28px] leading-10 font-black">About Summon.AI</h1>
			<VerticalSpace space="medium" />
			<Text className="text-base leading-6 font-medium" as={"p"}>
				Summon.AI is an open-source AI design tool allowing you to generate and edit beautiful images, powered by{" "}
				<Link target="_blank" href="https://openai.com/dall-e-2/">
					DALL-E-2
				</Link>
				.
				<br />
				P.S. The token you use is not saved anywhere other than Figma's local storage.
			</Text>
			<VerticalSpace space="medium" />
			<Text className="text-base leading-6 font-medium" as={"p"}>
