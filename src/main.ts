			...
			if (figma.currentPage.selection.length > 0) {
				...
				if (frames.length > 0) {
					...
					nodes.forEach((node, index) => {
						...
						if (index === 0) {
							...
							promptText.y = frames[0].height / 2 - promptText.height / 2 - 100 - IMAGE_SIZE / 2;
					...
					nodes.forEach((node, index) => {
						...
						if (index === 0) {
							...
							promptText.x = nonFrames[0].width / 2 - promptText.width / 2;
							promptText.y = nonFrames[0].height / 2 - promptText.height / 2 - 150 - IMAGE_SIZE / 2;
				...
				nodes.forEach((node, index) => {
					...
					if (index === 0) {
						...
						promptText.y = figma.viewport.center.y - promptText.height / 2 - 150 - IMAGE_SIZE / 2;
