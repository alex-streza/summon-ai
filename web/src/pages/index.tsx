...
const Home: NextPage = () => {
  return (
    <Layout>
      <NextSeo title="Summon AI - coming soon" />
      <h1 className="mt-16 mb-12 text-4xl md:text-7xl">
        <div>
          <span className="mr-3 font-serif text-5xl font-bold italic md:mr-12 md:text-8xl">
            Evolving
          </span>
        ...
        <div>
          ...
          <span className="ml-3 font-serif text-5xl font-bold italic md:ml-12 md:text-8xl">
            Figma
          </span>
        </div>
      </h1>
