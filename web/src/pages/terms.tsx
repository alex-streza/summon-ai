  ...
  <div data-custom-class="body" className="p-10">
    ...
    <div style={{ lineHeight: "1.5" }}>
      <a data-custom-class="link" href="#submissions">
        <span data-custom-class="body_text">9. SUBMISSIONS</span>
      </a>
    </div>
    <div style={{ lineHeight: "1.5" }}>
      <bdt className="block-component">
    ...
    <div style={{ lineHeight: "1.5" }}>
      <a data-custom-class="link" href="#sitemanage">
        <span data-custom-class="body_text">10. SITE MANAGEMENT</span>
      </a>
    </div>
    <div style={{ lineHeight: "1.5" }}>
      <bdt className="block-component">
    ...
    <div style={{ lineHeight: "1.5" }}>
      <a data-custom-class="link" href="#liability">
        <span data-custom-class="body_text">17. LIMITATIONS OF LIABILITY</span>
      </a>
    </div>
    <div style={{ lineHeight: "1.5" }}>
    ...
    >
      <strong>
        <span style={{ fontSize: "19px" }}>15. CORRECTIONS</span>
      </strong>
    </div>
    <div className="MsoNormal" style={{ lineHeight: 1 }}>
      <br />
    ...
    >
      <strong>
        <span style={{ fontSize: "19px" }}>16. DISCLAIMER</span>
      </strong>
    </div>
    <div className="MsoNormal" style={{ lineHeight: 1 }}>
      <br />
    ...
    >
      <strong>
        <span style={{ fontSize: "19px" }}>17. LIMITATIONS OF LIABILITY</span>
      </strong>
    </div>
    <div className="MsoNormal" style={{ lineHeight: 1 }}>
      <br />
    ...
    >
      <strong>
        <span style={{ fontSize: "19px" }}>18. INDEMNIFICATION</span>
      </strong>
    </div>
    <div className="MsoNormal" style={{ lineHeight: 1 }}>
      <br />
    ...
    >
      <strong>
        <span style={{ fontSize: "19px" }}>19. USER DATA</span>
      </strong>
    </div>
    <div className="MsoNormal" style={{ lineHeight: 1 }}>
      <br />
    ...
    >
      <strong>
        <span style={{ fontSize: "19px" }}>21. MISCELLANEOUS</span>
      </strong>
    </div>
    <div className="MsoNormal" style={{ lineHeight: 1 }}>
      <br />
